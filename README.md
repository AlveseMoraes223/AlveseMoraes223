...
Meu foco é transformar dados financeiros e operacionais em informações que realmente apoiem decisões: **o que aconteceu, por que aconteceu, onde está o desvio, qual o impacto financeiro e qual ação deve ser tomada**.

Mais do que construir dashboards, trabalho na estruturação do caminho completo da informação — da origem no ERP e planilhas, passando por tratamento, modelagem, governança e automação, até chegar à visão executiva.

Tenho especial interesse em soluções que conectem **TOTVS Protheus, Excel, Power BI, SQL, bancos relacionais, Supabase, automações e aplicações web** para reduzir trabalho manual, aumentar a confiabilidade dos dados e melhorar a capacidade de gestão.

```text
ERP / Fontes Operacionais
        ↓
Tratamento & Governança
        ↓
Modelagem de Dados
        ↓
Automação & Integração
        ↓
BI / Sistemas Gerenciais
        ↓
Indicadores → Diagnóstico → Decisão → Ação
```
...
| Área | Aplicação |
|---|---|
| **DRE Gerencial** | Estruturação, classificação, análise vertical/horizontal e visão executiva |
| **Budget & Forecast** | Planejamento, realizado x orçamento, tendências e projeções |
| **Custos** | Centros de custo, natureza de gasto, desvios e direcionadores |
| **CAPEX & OPEX** | Classificação, acompanhamento e análise de impacto financeiro |
...
|---|---|
| **O que aconteceu?** | KPIs, realizado, tendência e comparativos |
| **Por que aconteceu?** | Análise de variação, decomposição e causa raiz |
| **Onde está o problema?** | Centro de custo, obra, área, fornecedor, veículo ou processo |
| **Qual o impacto financeiro?** | DRE, custos, caixa, Budget, Forecast, CAPEX e OPEX |
| **É pontual ou tendência?** | Séries históricas, comparação temporal e projeções |
| **O que precisa de atenção?** | Alertas, exceções, desvios e indicadores críticos |
| **O que fazer agora?** | Priorização, plano de ação e acompanhamento |
...
<img src="https://img.shields.io/badge/SQL-111827?style=for-the-badge&logo=postgresql&logoColor=818CF8" />
<img src="https://img.shields.io/badge/TOTVS%20Protheus-111827?style=for-the-badge&logoColor=A78BFA" />
...
<img src="https://skillicons.dev/icons?i=python,postgres,supabase,github,git&theme=dark" />
...
<img src="https://skillicons.dev/icons?i=ts,js,react,vite,html,css&theme=dark" />

<br/><br/>

<img src="https://img.shields.io/badge/TypeScript-111827?style=for-the-badge&logo=typescript&logoColor=818CF8" />
<img src="https://img.shields.io/badge/React-111827?style=for-the-badge&logo=react&logoColor=A78BFA" />
<img src="https://img.shields.io/badge/Supabase-111827?style=for-the-badge&logo=supabase&logoColor=818CF8" />
...
Automação para conectar dados operacionais do **TOTVS Protheus** a uma camada analítica moderna, reduzindo dependência de extrações manuais e criando uma base preparada para dashboards e sistemas gerenciais.
...
O projeto aplica conceitos de **automação, integração com sistema legado, ingestão de dados e governança**, preservando o ERP como fonte transacional e utilizando uma camada separada para consumo analítico.
...
Sistema de inteligência de compras estruturado para consolidar pedidos, fornecedores, obras, aprovações e indicadores de performance.
...
Modelo analítico para acompanhamento de custos de frota com classificação por veículo, categoria, centro de custo e tipo de frota.
...
Ambiente de analytics para transformar dados de RH em indicadores econômicos e operacionais de força de trabalho.
...
Sistema integrado para centralização de informações, controles e indicadores relacionados à **Segurança e Saúde no Trabalho**.
...
Projeto orientado à consolidação de informações financeiras e operacionais em uma visão integrada de Controladoria.
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:8B5CF6,35:6D28D9,70:312E81,100:0B1020&height=120&section=footer" />